        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                ...
                                .requestMatchers(HttpMethod.POST,"/api/task").hasAuthority("MANAGER")
                                .requestMatchers(HttpMethod.DELETE,"/api/task/").hasAuthority("MANAGER")
                                .requestMatchers(HttpMethod.GET,"/api/task/{id}").hasAuthority("USER")
                                .requestMatchers(HttpMethod.PUT,"/api/task/").hasAuthority("USER")
                                .requestMatchers(HttpMethod.GET,"/api/task/").hasAnyAuthority("ADMIN", "MANAGER")
